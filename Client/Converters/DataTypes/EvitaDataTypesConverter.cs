...
public class EvitaDataTypesConverter
{
    public static object ToEvitaValue(GrpcEvitaValue value)
    {
        return value.Type switch
        {
            ...
            GrpcEvitaDataType.BigDecimalNumberRangeArray => ToDecimalNumberRangeArray(value.BigDecimalNumberRangeArrayValue),
    ...
    public static DateTimeRange ToDateTimeRange(GrpcDateTimeRange grpcDateTimeRange)
    {
        ...
        return DateTimeRange.Between(ToDateTimeOffset(grpcDateTimeRange.From!), ToDateTimeOffset(grpcDateTimeRange.To!));
    }
    ...
    public static DecimalNumberRange ToDecimalNumberRange(GrpcBigDecimalNumberRange grpcDecimalNumberRange)
    {
        ...
        return DecimalNumberRange.Between(ToDecimal(grpcDecimalNumberRange.From!), ToDecimal(grpcDecimalNumberRange.To!));
    }
    ...
    public static GrpcBigDecimalNumberRangeArray ToGrpcBigDecimalNumberRangeArray(DecimalNumberRange[] decimalNumberRangeArrayValues)
    {
        return new GrpcBigDecimalNumberRangeArray {Value = {decimalNumberRangeArrayValues.Select(ToGrpcBigDecimalNumberRange).ToArray()}};
    }
    ...
    {
        return new GrpcLongNumberRangeArray {Value = {longNumberRangeArrayValues.Select(ToGrpcLongNumberRange).ToArray()}};
    }
    
    public static GrpcIntegerNumberRange ToGrpcIntegerNumberRange<T>(NumberRange<T> numberRange) where T : struct, IComparable<T>, IEquatable<T>, IConvertible
    {
    ...
    public static GrpcIntegerNumberRangeArray ToGrpcIntegerNumberRangeArray(IntegerNumberRange[] integerRangeArrayValues)
    {
        return new GrpcIntegerNumberRangeArray { Value = { integerRangeArrayValues.Select(ToGrpcIntegerNumberRange).ToArray() }};
    }
    
    public static GrpcIntegerNumberRangeArray ToGrpcIntegerNumberRangeArray(ShortNumberRange[] shortRangeArrayValues)
    {
        return new GrpcIntegerNumberRangeArray { Value = { shortRangeArrayValues.Select(ToGrpcIntegerNumberRange).ToArray() }};
    }
    
    public static GrpcIntegerNumberRangeArray ToGrpcIntegerNumberRangeArray(ByteNumberRange[] byteRangeArrayValues)
    {
        return new GrpcIntegerNumberRangeArray { Value = { byteRangeArrayValues.Select(ToGrpcIntegerNumberRange).ToArray() }};
    }
