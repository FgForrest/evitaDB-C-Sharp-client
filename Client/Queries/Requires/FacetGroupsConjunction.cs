...
public class FacetGroupsConjunction : AbstractRequireConstraintContainer
{
    ...
    public FilterBy FacetGroups => AdditionalChildren.OfType<FilterBy>().FirstOrDefault() ??
                                   throw new EvitaInvalidUsageException("FacetGroupsConjunction requires FilterBy constraint.");
    ...
    private FacetGroupsConjunction(string referenceName, FilterBy filterBy) : base(new object[] {referenceName},
        NoChildren, filterBy)
    {
    }
