...
public class SetAttributeSchemaUniqueMutation : IEntityAttributeSchemaMutation,
    ...
    IReferenceAttributeSchemaMutation, ILocalCatalogSchemaMutation
{
    ...
    public TS Mutate<TS>(ICatalogSchema? catalogSchema, TS? attributeSchema, Type type) where TS : class, IAttributeSchema
    {
